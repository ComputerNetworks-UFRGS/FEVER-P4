...
df.drop(['Cycles', 'Branches', 'Branch Misses', 'Task Clock (msec)', 'Time Elapsed (s)',' RSS (%)',' Virtual Memory Size',' Total Memory Usage (%)'], inplace = True, axis = 1)
...
for feat_hist in df.columns:
    ...
    plt.plot(data_hist_0,label=feat_hist+input_file_name,color="blue")
    plt.plot(data_hist_1,label=feat_hist+input_file_name2,color="red")
