...
for i in range(len(features)):
    ...
    remaining_features = [feat for feat in features if feat != features[i]]
    ...
    f1 = calculate_f1_score_lof(X_train_single_feature, X_test_single_feature)
    f1_scores_lof.append(f1)
    f1 = calculate_f1_score_vm(X_train_single_feature, X_test_single_feature)
