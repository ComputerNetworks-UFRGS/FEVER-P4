...
# Plotting F1-Scores
plot_f1_scores(features, f1_scores, 'LOF F1-Scores for Each Feature')
plot_f1_scores(features, f1_scores_anomalous, 'LOF F1-Scores for Each Feature (Anomalous)')
plot_f1_scores(features, f1_scores_modified, 'LOF F1-Scores for Each Feature(Modified)')
