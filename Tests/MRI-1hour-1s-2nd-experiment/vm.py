...
df_normal.drop(['Time Elapsed (s)',' RSS (%)',' Virtual Memory Size',' Total Memory Usage (%)', 'Total CPU Usage (%)'], inplace = True, axis = 1)
df_anomalous.drop(['Time Elapsed (s)',' RSS (%)',' Virtual Memory Size',' Total Memory Usage (%)', 'Total CPU Usage (%)'], inplace = True, axis = 1)
df_modified.drop(['Time Elapsed (s)',' RSS (%)',' Virtual Memory Size',' Total Memory Usage (%)', 'Total CPU Usage (%)'], inplace = True, axis = 1)
